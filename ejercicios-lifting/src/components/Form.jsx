...
function Form({handleForm, handleName, name, handleEmail, email, handleRegion, region, handlePaymentType, paymentType, handleLegalTerms, legalTerms}) {
...
Form.propTypes = {
    ...
    handleLegalTerms: PropTypes.func,
  };